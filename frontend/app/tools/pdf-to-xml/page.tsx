...
export default function PDFToXMLPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await conversionsApi.pdfToXml(documentId);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-slate-500 to-slate-600 flex items-center justify-center">
                        <FileCode className="w-10 h-10 text-white" />
                    </div>
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">PDF to XML</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Convert your PDF documents to structured XML format for easy data integration and processing.
                    </p>
                </div>
                            ...
                            {!documentId ? (
                                ...
                                <div className="p-4 bg-gray-50 rounded-xl flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-500">Ready to convert to XML</p>
                                    </div>
                        ...
                        <>
                            ...
                            {resultUrl && (
                                <div className="mt-6 flex gap-4">
                                    <DownloadButton url={resultUrl} fallbackName="result.xml" className="flex-1 btn-primary flex items-center justify-center gap-2">
