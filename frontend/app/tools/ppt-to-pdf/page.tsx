...
import { FileText, ArrowLeft, Download, Loader2, Presentation } from 'lucide-react';
...
export default function PPTToPDFPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await conversionsApi.pptToPdf(documentId);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-orange-600 to-orange-700 flex items-center justify-center">
                        <Presentation className="w-10 h-10 text-white" />
                    </div>
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">PowerPoint to PDF</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Convert Microsoft PowerPoint presentations (PPT, PPTX) to PDF format with all slides preserved.
                    </p>
                </div>
                        ...
                        <>
                            ...
                            {resultUrl && (
                                <div className="mt-6 flex gap-4">
                                    <DownloadButton
                                        url={resultUrl}
                                        fallbackName={fileName?.replace(/\.[^.]+$/, '') + '.pdf'}
