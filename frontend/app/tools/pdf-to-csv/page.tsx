...
export default function PDFToCSVPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await conversionsApi.pdfToCsv(documentId);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-gray-500 to-gray-600 flex items-center justify-center">
                        <FileCode className="w-10 h-10 text-white" />
                    </div>
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">PDF to CSV</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Extract tabular data from your PDF documents and export directly to CSV format.
                    </p>
                </div>
                            ...
                            {!documentId ? (
                                ...
                                <div className="p-4 bg-gray-50 rounded-xl flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-500">Ready to extract tables</p>
                                    </div>
