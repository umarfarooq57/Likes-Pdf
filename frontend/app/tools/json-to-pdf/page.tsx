...
export default function JSONToPDFPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await conversionsApi.jsonToPdf(documentId);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">JSON to PDF</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Render your JSON data into a readable and professional PDF document. Ideal for exporting settings or logs.
                    </p>
                </div>
