...
import { FileText, ArrowLeft, Download, Loader2, Trash2 } from 'lucide-react';
...
export default function DeletePagesPage() {
    ...
    const handleDelete = async () => {
        ...
        try {
            const result = await editingApi.deletePages(documentId, selectedPages);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-red-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Delete Pages</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Remove unwanted pages from your PDF. Select the pages you want to delete.
                    </p>
                </div>
                        ...
                        <>
                                ...
                                <div className="mt-8">
                                    ...
                                    {selectedPages.length > 0 && (
                                        <p className="mt-4 text-sm text-gray-500">
                                            Pages to delete: {selectedPages.join(', ')}
                                        </p>
                                    )}
                                </div>
                            )}
                            ...
                            {documentId && (
                                <button
                                    ...
                                    className="w-full mt-8 bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
                                    {isProcessing ? (
                                        <>
