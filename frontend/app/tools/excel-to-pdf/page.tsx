...
import { FileText, ArrowLeft, Download, Loader2, Table } from 'lucide-react';
...
export default function ExcelToPDFPage() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const result = await conversionsApi.excelToPdf(documentId);
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50">
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-green-600 to-green-700 flex items-center justify-center">
                        <Table className="w-10 h-10 text-white" />
                    </div>
                    <h1 className="text-4xl font-bold text-gray-900 mb-4">Excel to PDF</h1>
                    <p className="text-gray-600 max-w-lg mx-auto">
                        Convert Microsoft Excel spreadsheets (XLS, XLSX) to PDF format with perfect table formatting.
                    </p>
                </div>
